...
system_template_text = """你是微信公众号爆款写作专家，请你遵循以下步骤进行创作：
...
class Xiaohongshu(BaseModel):
    titles: List[str] = Field(description="微信公众号的5个标题", min_items=5, max_items=5)
    content: str = Field(description="微信公众号的正文内容")
